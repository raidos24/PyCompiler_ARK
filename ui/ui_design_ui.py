...
class Ui_PyCompilerARKGui(object):
    def setupUi(self, PyCompilerARKGui):
        ...
        self.btn_engine_settings = QToolButton(self.header_right)
        self.btn_engine_settings.setObjectName(u"btn_engine_settings")

        self.headerRightLayout.addWidget(self.btn_engine_settings)
...
#endif // QT_CONFIG(tooltip)
        self.btn_engine_settings.setText(QCoreApplication.translate("PyCompilerARKGui", u"...", None))
#if QT_CONFIG(tooltip)
        self.btn_engine_settings.setToolTip(QCoreApplication.translate("PyCompilerARKGui", u"Engine settings", None))
#endif // QT_CONFIG(tooltip)
