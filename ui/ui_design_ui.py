...
class Ui_PyCompilerARKGui(object):
    def setupUi(self, PyCompilerARKGui):
        if not PyCompilerARKGui.objectName():
            PyCompilerARKGui.setObjectName("PyCompilerARKGui")
        ...
        self.headerLeftLayout.setObjectName("headerLeftLayout")
        ...
        self.headerRightLayout.setObjectName("headerRightLayout")
        ...
        self.layout_workspace_grid.setObjectName("layout_workspace_grid")
        ...
        self.venv_button.setObjectName("venv_button")
        ...
        self.layout_files_grid.setObjectName("layout_files_grid")
        ...
        self.layout_file_actions.setObjectName("layout_file_actions")
        ...
        self.fileActionsSpacer = QSpacerItem(
        ...
        self.layout_tools_grid.setObjectName("layout_tools_grid")
        ...
        self.label_options_section.setObjectName("label_options_section")
        ...
        self.layout_logs.setObjectName("layout_logs")
    ...
    def retranslateUi(self, PyCompilerARKGui):
        self.label_app_title.setText(
            QCoreApplication.translate("PyCompilerARKGui", "PyCompiler ARK++", None)
        )
        self.label_workspace_status.setText(
            QCoreApplication.translate("PyCompilerARKGui", "Workspace : Aucun", None)
        )
        self.select_lang.setText(
            QCoreApplication.translate("PyCompilerARKGui", "\U0001f310 Langue", None)
        )
        # if QT_CONFIG(tooltip)
        self.select_lang.setToolTip(
            QCoreApplication.translate(
                "PyCompilerARKGui", "Choisir la langue de l'interface", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.select_theme.setText(
            QCoreApplication.translate(
                "PyCompilerARKGui", "\U0001f3a8 Th\U000000e8me", None
            )
        )
        # if QT_CONFIG(tooltip)
        self.select_theme.setToolTip(
            QCoreApplication.translate(
                "PyCompilerARKGui", "Choisir le th\u00e8me de l'interface", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.compile_btn.setText(
            QCoreApplication.translate("PyCompilerARKGui", "\U0001f680 Compiler", None)
        )
        # if QT_CONFIG(tooltip)
        self.compile_btn.setToolTip(
            QCoreApplication.translate(
                "PyCompilerARKGui", "Lancer la compilation", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.cancel_btn.setText(
            QCoreApplication.translate("PyCompilerARKGui", "\u26d4 Annuler", None)
        )
        # if QT_CONFIG(tooltip)
        self.cancel_btn.setToolTip(
            QCoreApplication.translate(
                "PyCompilerARKGui", "Annuler la compilation en cours", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.label_folder.setText(
            QCoreApplication.translate(
                "PyCompilerARKGui", "Aucun dossier s\u00e9lectionn\u00e9", None
            )
        )
        self.venv_label.setText(
            QCoreApplication.translate(
                "PyCompilerARKGui", "venv s\u00e9lectionn\u00e9 : Aucun", None
            )
        )
        self.venv_button.setText(
            QCoreApplication.translate(
                "PyCompilerARKGui", "Choisir un dossier venv manuellement", None
            )
        )
        self.btn_select_folder.setText(
            QCoreApplication.translate("PyCompilerARKGui", "\U0001f4c1 Workspace", None)
        )
        # if QT_CONFIG(tooltip)
        self.btn_select_folder.setToolTip(
            QCoreApplication.translate(
                "PyCompilerARKGui", "S\u00e9lectionner le dossier de travail", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.btn_clear_workspace.setText(
            QCoreApplication.translate(
                "PyCompilerARKGui", "\U0001f9f9 Clear workspace", None
            )
        )
        # if QT_CONFIG(tooltip)
        self.btn_clear_workspace.setToolTip(
            QCoreApplication.translate(
                "PyCompilerARKGui",
                "Vider la liste des fichiers et r\u00e9initialiser la s\u00e9lection",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.label_files_section.setText(
            QCoreApplication.translate(
                "PyCompilerARKGui", "2. Fichiers \u00e0 compiler", None
            )
        )
        self.file_filter_input.setPlaceholderText(
            QCoreApplication.translate(
                "PyCompilerARKGui", "Filtrer la liste\u2026", None
            )
        )
        self.btn_select_files.setText(
            QCoreApplication.translate("PyCompilerARKGui", "\U0001f4cb Fichiers", None)
        )
        # if QT_CONFIG(tooltip)
        self.btn_select_files.setToolTip(
            QCoreApplication.translate(
                "PyCompilerARKGui", "Ajouter des fichiers \u00e0 compiler", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.btn_remove_file.setText(
            QCoreApplication.translate(
                "PyCompilerARKGui",
                "\U0001f5d1\U0000fe0f Supprimer le fichier s\U000000e9lectionn\U000000e9",
                None,
            )
        )
        self.label_tools.setText(
            QCoreApplication.translate("PyCompilerARKGui", "Outils", None)
        )
        self.btn_suggest_deps.setText(
            QCoreApplication.translate(
                "PyCompilerARKGui", "\U0001f50e D\U000000e9pendances", None
            )
        )
        # if QT_CONFIG(tooltip)
        self.btn_suggest_deps.setToolTip(
            QCoreApplication.translate(
                "PyCompilerARKGui", "Analyser les d\u00e9pendances du projet", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.btn_bc_loader.setText(
            QCoreApplication.translate(
                "PyCompilerARKGui", "\U0001f9e9 Bc Plugins Loader", None
            )
        )
        # if QT_CONFIG(tooltip)
        self.btn_bc_loader.setToolTip(
            QCoreApplication.translate(
                "PyCompilerARKGui", "Charger Bc Plugins Loader", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.btn_show_stats.setText(
            QCoreApplication.translate(
                "PyCompilerARKGui", "\U0001f4ca Statistiques", None
            )
        )
        # if QT_CONFIG(tooltip)
        self.btn_show_stats.setToolTip(
            QCoreApplication.translate(
                "PyCompilerARKGui", "Afficher les statistiques de compilation", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.btn_help.setText(
            QCoreApplication.translate("PyCompilerARKGui", "\u2753 Aide", None)
        )
        # if QT_CONFIG(tooltip)
        self.btn_help.setToolTip(
            QCoreApplication.translate("PyCompilerARKGui", "Afficher l'aide", None)
        )
        # endif // QT_CONFIG(tooltip)
        self.label_options_section.setText(
            QCoreApplication.translate(
                "PyCompilerARKGui", "3. Options de compilation", None
            )
        )
        self.label_logs_section.setText(
            QCoreApplication.translate(
                "PyCompilerARKGui", "4. Logs de compilation", None
            )
        )
        self.label_progress.setText(
            QCoreApplication.translate("PyCompilerARKGui", "Progression", None)
        )
        pass
