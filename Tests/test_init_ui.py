...
class TestApplyTranslations:
    """Test _apply_main_app_translations function"""

    def test_apply_main_app_translations_function_exists(self):
        """Test that _apply_main_app_translations function exists"""
        from Core.i18n import _apply_main_app_translations

        assert callable(_apply_main_app_translations)

    def test_apply_main_app_translations_with_mock_gui(self):
        ...
        # Should not raise exception
        _apply_main_app_translations(mock_gui, translations)
